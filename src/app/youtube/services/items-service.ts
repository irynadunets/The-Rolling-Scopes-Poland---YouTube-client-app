...
export class ItemsService {
  ...
  public items: IVideoItem[] = [
    {
      ...
      'id': 'YN8zNnV0sK8',
      'snippet': {
        'publishedAt': '2020-07-30T12:42:19.000Z',
    ...
    },
    {
      ...
      'id': 'k5E2AVpwsko',
      'snippet': {
        'publishedAt': '2020-08-05T16:48:15.000Z',
    ...
    },
    {
      ...
      'id': 'u1VCxpvDgsk',
      'snippet': {
        'publishedAt': '2019-12-01T15:00:05.000Z',
    ...
    },
    {
      ...
      'id': 'NaZwVUHnmfE',
      'snippet': {
        'publishedAt': '2020-06-19T16:06:13.000Z',
        'channelId': 'UCg8ss4xW9jASrqWGP30jXiw',
    ...
    },
    {
      ...
      'id': 'G0bBLvWXBvc',
      'snippet': {
        'publishedAt': '2020-07-16T16:53:41.000Z',
  ...
  public getData(): IVideoItem[] {
    return this.items;
  }

  public getItem(id: string): IVideoItem {
